...
#     "python -m sglang.launch_server --model-path CohereForAI/aya-expanse-8b --mem-fraction-static 0.7 --port 30024 --host 0.0.0.0"
# )

# wait_for_server("http://localhost:30024")

class BasicGenerator:
    def __init__(self, model_name_or_path):
        logger.info(f"Loading model from {model_name_or_path} in dev org file *******")
