...
class DPR_Retriever:
    def __init__(self):
        ############# Parameters #############
        pretrained_model_cfg = '/scratch/mariam.saeed/side/advanced-nlp/DRAGIN/ArabicaQA/DPR/Model'
        sequence_length = 384
        vector_size = 768
        do_lower_case = True
        dropout = 0.1
        ...
        # index all passages
        self.retriever.index.deserialize('/scratch/mariam.saeed/side/advanced-nlp/DRAGIN/ArabicaQA/DPR/DPR_index')
