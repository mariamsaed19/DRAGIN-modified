...
# from transformers.models impor
...
class HFBertEncoder(BertModel):
    ...
    def forward(
        ...
        if self.config.output_hidden_states:
            ...
            sequence_output, pooled_output, hidden_states =  out.last_hidden_state,out.pooler_output,out.hidden_states
        else:
            # print("here else")
            hidden_states = None
            out = super().forward(
        ...
        if isinstance(representation_token_pos, int):
            # print("representation_token_pos--->",representation_token_pos)
